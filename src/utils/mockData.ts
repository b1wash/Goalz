...
//SIRVE COMO MOLDE INICIAL PARA LA BASE DE DATOS Y PARA PROBAR LA APLICACION
//CUANDO INSTALAMOS EL PROYECTO O BORRAMOS EL ARCHIVO DB.JSON SE CREA ESTE ARCHIVO CON ESTOS DATOS
// USUARIOS DE EJEMPLO
